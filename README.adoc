...
Extensions not listed above can be installed by placing an `extensions.local.json` file in the root of your repository. See the link:docs/use-case-local-development.adoc#_installing_non_bundled_extensions_with_extensions_local_json[Local Development guide] for the full format and examples.
